...
const string const_declkey = "const";
...
//----------------------------------------------------------------------------------
Variable::Variable(string s, double d, bool b) : name{s}, value{d}, isconst{b}
{}
//-----------------------------------------------------------------------------------
...
//-------------------------------------------------------------
double define_name(string var, double val, bool isconst = false){
...
double declaration(bool isconst=false){
    ...
    double d = expression();
    define_name(var_name, d, isconst);
    return d;
}
//--------------------------------------------------------------------------------
double statement(){
